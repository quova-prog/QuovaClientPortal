...
If testing a newly invited user, also save either the full copied invite URL or
the email link's `invitation_token` query parameter as
`WORKOS_PHASE0_INVITATION_TOKEN`.
