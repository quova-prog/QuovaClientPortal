...
function addPageFooter(doc: jsPDF, pageNum: number) {
  ...
  doc.text('Quova — The Financial Risk OS', 18, 289)
...
function addCompliancePage(doc: jsPDF, data: BoardReportData, pageNum: number) {
  ...
  doc.setFontSize(7.5)
  doc.text(
    `This report was generated by Quova on ${fmtDate(data.generatedAt)}. For questions contact your Treasury team.`,
    105,
    260,
    { align: 'center' },
  )
...
export function generateBoardReportPdf(data: BoardReportData): void {
  ...
  doc.save(`Quova_Board_Report_${periodSlug}_${dateStr}.pdf`)
}
